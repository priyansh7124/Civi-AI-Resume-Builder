...
**Civi** is an AI-powered resume builder designed to help users create professional, customized resumes with ease. By leveraging AI, ResumeCraft ensures that each resume is tailored to highlight the user’s skills, experience, and achievements effectively.
...
For any questions or feedback, please reach to me directly  [Abhishek Rajpoot](https://github.com/priyansh7124). -->


# Civi (ResumeCraft)

![Project Badge](https://img.shields.io/badge/Project-Civi-blue)
...
[Live Demo Link Here](#)  
*Paste your Netlify or Vercel link here later.*
...
This project is **private** and currently not open-source.
